        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.div variants={fadeIn}>
              ...
              <p className="text-3xl font-semibold text-[#67B142] mb-8">
                100% made in Senegal
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeIn} className="flex gap-4 pt-4">
              <Link href="/signup">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="px-6 py-3 bg-[#67B142] text-white rounded-[6px] hover:bg-[#4e8a2f] transition-colors font-medium"
                >
              ...
              <Link href="/contact">
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="px-6 py-3 bg-gray-900 text-white rounded-[6px] hover:bg-gray-800 transition-colors font-medium"
                >
                  En savoir plus
                </motion.button>
              </Link>
